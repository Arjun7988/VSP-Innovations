/*
  # Update portfolio table with additional fields

  1. Changes
    - Add client_name field for storing client information
    - Add comments field for additional notes
    - Add client_image_url field for client logo/image
    - Rename live_url to website_url to better reflect its purpose
