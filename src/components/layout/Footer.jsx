...
const Footer = () => {
  ...
  const contactInfo = [
    { icon: <FaPhone />, text: '+91 8886100028', href: 'tel:+918886100028' },
    { icon: <FaEnvelope />, text: 'arjun@vspinnovations.com', href: 'mailto:arjun@vspinnovations.com' },
          ...
          <div className="space-y-6">
            <Link to="/" className="inline-block">
              <div className="relative">
                <h2 className="text-2xl font-bold bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent text-center">
                  VSP INNOVATIONS
                </h2>
                <span className="text-sm text-gray-400 block text-center mt-1">
                  AI AGENCY
                </span>
              </div>
            </Link>
